...
* <u>Gestion des archives :</u> 
    ...
    * en interne, la mise au point d'un outil S3 ne va pas de soi, vu qu'il s'agit de pourvoir exploiter des processus/champs sans structure (ongestructureerde processen)
...
* [Tableau des besoins (&larr;S1)](Besoins_B_Aperçu_postes_PP2020_2021.pdf) sur base des plans de personnel 2020-2021
    ...
    * Pour ce qui concerne S2, on a ainsi un *Quick Win* possible pour :
    ...
    * Robert : communiquera ces besoins à S1 (*deadline : 03.09.2020), ainsi que les membres de jurys que S2 pourra mettre à disposition
* [Wijzigingen organisatiestructuur S2](Voorstel_MLenaerts_V2_Organisatiestructuur_S2.xls)
    ...
    * ces propositions étant acceptées seront communiquées par Mathias avant le 04.09
* Affectation de Hubert Samson
    * Mathias : statutaire (Niveau B) offre lui a été faite, vu le mécontentement à propos de son fonctionnement au NG, de devenir contact-bâtiment à Gand
    * il lui était interdit de prendre contact avec Karel Pede ; pourtant, il l'a fait
    * RMass : le mentionner dans un (2ème!) entretien de fonctionnement et en tenir compte lors de l'entretien d'évaluation (&#8594;à amélirorer)
* Attitude de Chantal Luyten
    * Mathias : longue discussion (polémique, injures) le 31.08
    * Robert : la collaboration avec le personnel d'accueil de l'Atrium (Myriam Clemhaut, Ann Lammens, Ingrid Peetermans) semble impossible
    * idem pour ce qui est de la collaboration (respect) vis-à-vis du chef Vincent Danckaert
    * Mathias : doute sérieusement de la possibilité de déplacer Chantal Luyten à l'accueil du NG
    * Robert : Chantal a 49 ans, est contractuelle et a une ancienneté d'environ 20 ans
...
* Gestion quotidienne :
    ...
    * Une nouvelle vague de promotions sera lancée en novembre
        ...
        * Edward : vu l'entrée en service de Sophie Peuskens, il est recommandé de ne pas donner le signal que Denis Mailleux pourrait devenir son 'chef', du moins lors de la vague de novembre 2020
...
| Point | Qui ? | Quand ? | Suivi |
| --- | :---: | --- | --- | --- |
| Restaurant NG<br>Quid Sodexo? | RMass | &nbsp; | Réouverture : 07.09<br>Quid exploitation restaurant après fin contrat Sodexo ? |
